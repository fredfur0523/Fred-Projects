...
import type { FunnelLevel, FunnelMetrics, Site } from "../types";
...
export const calcFunnel = (sites: Site[], domain: string, zone: string, volFilter: string): FunnelMetrics => {
	...
	const pe0 = (byScore[0].length / n) * 100,
		pe1 = (byScore[1].length / n) * 100,
		pe2 = (byScore[2].length / n) * 100,
		pe3 = (byScore[3].length / n) * 100;
...
export const barColor = (l: string) =>
	l === "L0" ? "#D1D5DB" : l === "L1" ? "#FFE066" : l === "L2" ? "#FFC000" : l === "L3" ? "#F59E0B" : "#10B981";
