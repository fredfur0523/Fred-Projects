...
import type { Site, AnaplanRow } from '../types';
import { PLANT_TO_SITE_OVERRIDE, KPI_EPT, KPI_OST, STUDY_KPI_OSE_PRECALC, STUDY_KPI_TTP } from '../constants/kpis';
...
export function getSiteOseTtp(sites: Site[], anaplanRows: AnaplanRow[]): Record<string, { ose: number | null; ttp: number | null }> {
