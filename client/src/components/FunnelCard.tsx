...
import type { Site, KpiHistoryData } from '../types';
import type { T } from '../constants/translations';
import { GHQ_TOTALS } from '../constants/domains';
import { calcFunnel, barColor } from '../utils/funnel';
...
export const FunnelCard: React.FC<FunnelCardProps> = ({title,subtitle,domain,zone,volFilter,sites,isFeatured,accent,t,dark,kpiHistory}) => {
