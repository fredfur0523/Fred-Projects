					...
					{groups.map((g) => {
						...
						return (
							<button
								...
								className={
									"w-full px-3 py-2 rounded-lg font-bold transition-all flex items-center gap-2.5 " +
									(active
							...
							>
								...
								<span
									className={
										"text-[10px] font-normal " + (active ? "text-gray-700" : dark ? "text-gray-500" : "text-gray-400")
									}
								>
									{g.range}
								</span>
								<span
									className={
										"text-[10px] font-bold tabular-nums min-w-[28px] text-right " +
										(active ? "text-gray-800" : dark ? "text-gray-400" : "text-gray-400")
									}
								>
									{count}
								</span>
			...
			<div className={"rounded-xl border shadow-sm overflow-hidden " + card}>
					...
					{(
						...
						return (
							...
							>
								...
								<span
									className={
										"text-[10px] font-normal truncate max-w-[80px] " +
										(active ? "text-gray-700" : dark ? "text-gray-500" : "text-gray-400")
									}
								>
									{g.desc}
								</span>
				...
				<div className={"px-4 pb-2 pt-1 border-t " + hdr}>
					<p className="text-[9px] leading-snug">
						Tercis do dataset. Volume real (9 KPIs PB-R0xxx) quando disponível; proxy pela variância de scores de
						domínio caso contrário.
					</p>
				</div>
			</div>
						...
						return (
							<div key={l.code} className="flex items-stretch gap-2.5">
								<div className="flex flex-col items-center w-6 flex-shrink-0">
									<div
										className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 border border-black/10"
								...
								<div className={"py-1 " + (!isLast ? "pb-2" : "")}>
									<p className={"text-[11px] font-bold leading-tight " + (dark ? "text-gray-200" : "text-gray-800")}>
										{info.label}
									</p>
