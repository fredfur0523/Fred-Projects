...
export interface Site { zone: string; name: string; country: string; volume: number; group: string; scores: Record<string, number>; }

// Product coverage data: loaded from product-coverage-2026.json
export interface ProductDeployment { product: string; sites: string[]; n: number; }
