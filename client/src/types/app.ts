...
// Funnel types
export interface FunnelLevel { level: string; pct: number; siteCount: number; exclusiveSites: Site[]; ghq: number; }
export interface FunnelMetrics { avg: string; totalSites: number; funnel: FunnelLevel[]; }

// Quadrant / navigation types
export type QuadrantFilter = 'all' | 'tech_high_vpo_high' | 'tech_high_vpo_low' | 'tech_low_vpo_high' | 'tech_low_vpo_low';
